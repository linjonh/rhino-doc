...
|  ---  |  ---  |  ---  |  ---  |
|  Rhino 1.7.15  |  2022-05-04  |  [Release Notes](rhino_1.7.15.md)  |  [Release](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_15_Release), [zip](https://github.com/mozilla/rhino/releases/download/Rhino1_7_15_Release/rhino-1.7.15.zip)  |
...
[^1]: Rhino Tools consist of:
    ...
    - [Shell](../tools/shell.md): Interactive JavaScript [REPL](https://en.wikipedia.org/wiki/Read%E2%80%93eval%E2%80%93print_loop)
    - [JavaScript Compiler](../tools/javascript_compiler.md): Command-line Utility to compile JavaScript to Java Class files
